...
const string strMessageMagic = "SummerCoin Signed Message:\n";
...
const int DAILY_BLOCKCOUNT =  1920;
...
int64_t GetProofOfStakeReward(int64_t nCoinAge, int64_t nFees)
{
    ...
    if(pindexBest->nHeight < 7 * DAILY_BLOCKCOUNT)
        ...
        nRewardCoinYear = 10 * 365 * MAX_MINT_PROOF_OF_STAKE;
    else if(pindexBest->nHeight < 30000 + 30 * DAILY_BLOCKCOUNT)
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "SummerCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Summer is comming";
        CTransaction txNew;
        ...
        txNew.strTxComment = "text:SummerCoin genesis block";
		CBlock block;
        ...
        block.nNonce   = 5474875;
        if(fTestNet)
        {
            block.nNonce   = 5401845;
        }
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("faa1550509b0082f063846a2b1790300e60b86b030113057c2dacfd106ff3ec6"));
        block.print();
